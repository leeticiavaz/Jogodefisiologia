...
<script type="text/javascript"><!--
	...
	CrosswordHeight = 25;
	Words = 10;
	WordLength = new Array(13, 8, 8, 8, 9, 5, 12, 22, 18, 15);
	Word = new Array("PERDA DE PESO", "OLIGÚRIA", "POLIÚRIA", "TIREOIDE", "OBESIDADE", "TUMOR", "VASOPRESSINA", "CONTRATILIDADE UTERINA", "HIPERPROLACTINEMIA", "CICLO MENSTRUAL");
	Clue = new Array("Uma das consequências dos tumores na hipófise", 
"A liberação em excesso de ADH pode causar __________________.", 
"Aumento da excreção de urina.", 
"Glândula que desempenha um papel no metabolismo sistêmico.", 
"É um sintoma da síndrome de Cushing.", 
"Aumento de uma massa anormal na glândula hipófise", 
"A ausência da ação desse hormônio pode causar a diabetes insipidus.", 
"O uso de ocitocina sintética durante o parto pode melhorar a _______________.", 
"Anomalia causada pela produção excessiva de prolactina.", 
"Na fase folicular se tem uma ação protagonista do FSH.");
	AnswerHash = new Array(81664, 41072, 25110, 78447, 48647, 36524, 23113, 40972, 69077, 45176);
	WordX = new Array(0, 6, 9, 15, 1, 2, 4, 12, 16, 7);
	WordY = new Array(4, 10, 12, 19, 20, 0, 3, 3, 3, 7);
...
?>
<h3>Parabéns!</h3>
<p>Você completou a cruzadinha!<a href="respostacruzadinha.php"> clique aqui </a> para finalizar o jogo!.
</p>
<?php
}else{
?>
<h3>Parabéns!</h3>
<p>Você completou a cruzadinha!<a href="cruzresprec.php"> clique aqui </a> para finalizar o jogo!
</p>
<?php
}
?>
