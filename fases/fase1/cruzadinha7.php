...
<script type="text/javascript"><!--
	...
	CrosswordHeight = 22;
	Words = 10;
	WordLength = new Array(5, 9, 13, 3, 15, 19, 20, 5, 20, 16);
	Word = new Array("ÚTERO", "OCITOCINA", "ANTIDIURÉTICO", "RIM", "EJEÇÃO DE LEITE", "CONTRAÇÕES RÍTMICAS", "RELAXAMENTO MUSCULAR", "URINA", "RESISTÊNCIA VASCULAR", "PRESSÃO ARTERIAL");
	Clue = new Array("Um dos órgãos alvo da ação da ocitocina.", 
"Reduz o sangramento durante o parto.", 
"Outro nome dado ao hormônio arginina vasopressina.", 
...
"Um efeito fisiológico do ADH é o aumento da _________________.");
	AnswerHash = new Array(78323, 57691, 25101, 42729, 39627, 4361, 11824, 34025, 19911, 4614);
	WordX = new Array(10, 11, 11, 12, 4, 4, 0, 19, 13, 1);
	WordY = new Array(1, 4, 6, 10, 12, 15, 17, 0, 1, 6);
